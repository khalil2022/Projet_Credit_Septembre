                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-8">
                        <h5 class="card-header m-0 me-2 pb-3">User Registration Date</h5>
...
Chart.defaults.parsing.dateSource = 'moment';
Chart.defaults.parsing.date = 'YYYY-MM-DD';
// Get the data from PHP
var data = <?php echo json_encode($result); ?>;

// Extract labels and counts
var labels = data.map(item => item.registration_date);
var counts = data.map(item => item.user_count);
console.log(labels);
console.log(counts);
...
const myChart = new Chart(ctx, configsss);
